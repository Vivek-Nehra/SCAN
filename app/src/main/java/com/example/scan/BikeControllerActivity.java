...
public class BikeControllerActivity extends AppCompatActivity implements HotspotManager.OnHotspotEnabledListener {
    private ConstraintLayout bikeDashboard, checkConnection, syncConnection, tripSummary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tripSummary = findViewById(R.id.trip_details);
        ...
        (findViewById(R.id.closeBtn)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tripSummary.setVisibility(View.GONE);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.contains("Release")) {
                if (result.contains("Error")){
                    ...
                    tripSummary.setVisibility(View.VISIBLE);
